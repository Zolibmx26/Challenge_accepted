...
Steps to run the program option1:
  - Download the .exe file together with libstdc++-6.dll and save them in the same folder.
  - Open Command Prompt and navigate to the folder where the files are saved.
  - Type the name of the .exe file followed by the associated arguments.
